...
COMMENT ON COLUMN release_summary.package_data IS '`data` from Kingfisher Process package_data table. This is the package data in either a release or record package. For compiled releaeses generated by Kingfisher Process this is NULL';
