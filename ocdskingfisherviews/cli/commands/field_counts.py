...
class FieldCountsCommand(ocdskingfisherviews.cli.commands.base.CLICommand):
    ...
    def run_logged_command(self, args):
        ...
        with self.engine.begin() as connection:
            ...
            connection.execute("Comment on column field_counts.collection_id IS 'id from the kingfisher collection table' ")
            ...
            connection.execute("Comment on column field_counts.path IS 'JSON path of the feild' ")
            connection.execute("Comment on column field_counts.object_property IS 'The total number of times the field at this path appears' ")
            connection.execute("Comment on column field_counts.array_count IS 'For arrays, the total number of items in this array across all releases' ")
